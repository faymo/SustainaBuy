...
const genAI = new GoogleGenerativeAI("AIzaSyCkHEGOS-dAhr38iT8dxH5OD4kKJ0bBhpo");
const model = genAI.getGenerativeModel({ model: "gemini-pro" });

export async function getSustainableAlternatives(url) {
  const prompt = `Use this url to look at the product, and give me a list of the name, price, and link of only 3 sustainable alternatives of the same or similar product. Make sure the product is more sustainable, so look for things like what material it's made out of, and the mass. Also look at the carbon footprint of similar products and compare it to this link. Make sure you dont have '**' in your format and MAKE SURE YOUR LINKS WORK AND SHOW THEM EVERYTIME. MAKE SURE YOUR LINK WORKS AND HAVE A NUMBER FOR THE C02 EMISSIONS!!!! Make sure you make it into this format.
Name: _____.
